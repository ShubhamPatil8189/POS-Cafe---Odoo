...
return (
  <div className="flex h-screen overflow-hidden bg-background">
    ...
    <div className="flex-1 flex flex-col overflow-hidden relative">
      ...
      <Navbar
        title={activeItem === 'floors' ? "Floor Plan" : "Design System"}
        subtitle={activeItem === 'floors' ? "Manage your restaurant layout" : "Café POS — Component Showcase"}
      />
